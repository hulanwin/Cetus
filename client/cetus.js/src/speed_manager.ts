...
export default class SpeedManager {
    ...
    private static ELEMENTS_IN_QUEUES = 5;         // Max number of elements in the queues
     ...
     * @param pBandwidth The speed at which the last object has been downloaded (units: KBps)
     */
     ...
     * @param pDSpeed The Decompression speed (units: KBps)
     */
    ...
    /**
     * Calculates and returns the average bandwidth over the last iterations (in KBps)
     */
    ...
    /**
     * Calculates and returns the average decompression speed over the last iterations (in KBps)
     */
